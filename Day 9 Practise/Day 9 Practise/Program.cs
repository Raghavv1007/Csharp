...
namespace Day_9_Practise
{
    ...
    class Program
    {
        ...
        public static void List_of_UDT_Eg()
        {
            ...
            emplist.Add(new Employee(101, "Raghav", "Infinite", 45000));
            emplist.Add(new Employee(104, "Nithin", "Infinite", 42000));
            emplist.Add(new Employee(103, "Raghau", "Infinite", 44000));
            emplist.Add(new Employee(102, "Abhishek", "Infinite", 40000));
